...
preds = torch.load(export_path + "class_emb.pt",map_location=device)
target = torch.load(export_path + "class_emb_target.pt",map_location=device)
...
plt.legend(['0 - Open', '1 - Off Topic',"2 - Unclear", "3 - Too broad", "4 - Opinion"])
plt.show()
